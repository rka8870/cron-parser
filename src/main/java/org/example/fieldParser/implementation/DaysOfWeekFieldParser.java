...
public class DaysOfWeekFieldParser extends AbstractFieldParser {

    private final FieldContext context;

    public DaysOfWeekFieldParser(int min, int max) {
    ...
    public String parseField(String field) throws InvalidCronException {
        return String.format("%-14s", "day of week")+getSpaceSeparatedValues(field,context);
    }
}
