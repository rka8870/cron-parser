...
public class MonthFieldParser extends AbstractFieldParser {

    private final FieldContext context;

    public MonthFieldParser(int min, int max) {
    ...
    public String parseField(String field) throws InvalidCronException {
        return String.format("%-14s", "month")+getSpaceSeparatedValues(field,context);
    }
}
