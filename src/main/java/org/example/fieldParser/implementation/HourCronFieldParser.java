...
public class HourCronFieldParser extends AbstractFieldParser {

    private final FieldContext context;

    public HourCronFieldParser(int min, int max) {
    ...
    public String parseField(String field) throws InvalidCronException {
        return String.format("%-14s", "hour")+getSpaceSeparatedValues(field,context);
    }
}
